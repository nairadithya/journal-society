...
\begin{proof}
	...
	Suppose inductively that Q(m) = P(n + m) is true. Then, from the definition of P, we know that P((n + m)++) is true.
	\begin{align*}
		P((n + m)++)	&=	P(n + m++)	\\
						&=	Q(m++)		\\
	\end{align*}
	      ...
	      \begin{proof}
		      ...
		      \begin{enumerate}
			      ...
			      \item For the axiom of replacement,
			            ...
			            $z \in \{y: Q(y) is true\}\Leftrightarrow Q(z) \text{is true or } P(x,z) \text{is true}$
			      \item For the axiom of infinity,

			            We take the property $P(x)$
		      \end{enumerate}
	      \end{proof}
